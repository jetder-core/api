...
var (
	...
	ErrBillingSetupPaymentMethodFirst = newError("api: billing setup payment method first")
	ErrBillingPaymentMethodNotFound   = newError("api: billing payment method not found")
